...
export default function Home() {
  ...
  return (
     <Stack className='Dine-home' component='header' position='relative'>
        ...
        <Box className='reveal' sx={{color: 'white',maxWidth: {lg: '700px'}, padding: {xs: '4em'}, position: 'relative', top: {xs: '9em', sm: '17em', md: '25em', lg: '2.5em'}, left: {lg: '5.5em'}, textAlign: {xs: 'center', lg: 'left'}}}>
