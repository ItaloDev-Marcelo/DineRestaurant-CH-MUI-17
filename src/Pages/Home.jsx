...
export default function Home() {
  ...
  return (
     <Stack className='Dine-home' component='header' position='relative'>
        ...
        <Box className='reveal home-element' sx={{color: 'white',maxWidth: {lg: '700px'}, padding: {xs: '4em'}, position: 'relative', top: {xs: '4em', sm: '24em',  lg: '1.5em'}, left: {lg: '5.5em'}, textAlign: {xs: 'center', lg: 'left'}}}>
