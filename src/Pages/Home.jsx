...
export default function Home() {
  ...
  return (
     <Stack className='Dine-home' component='header' position='relative'>
        <AppBar className='reveal' color='trasparent' position='static' sx={{display: {xs: 'none', lg: 'block'}, boxShadow: 'none', paddingTop: '3em', paddingLeft: '10em'}} >
           <img src={logo} alt=''/>
        </AppBar>
        <Box className='reveal' sx={{color: 'white',maxWidth: {lg: '700px'}, padding: {xs: '4em'}, position: 'relative', top: {xs: '9em', sm: '17em', md: '25em', lg: '1.5em'}, left: {lg: '5.5em'}, textAlign: {xs: 'center', lg: 'left'}}}>
           ...
           <Typography component='p' maxWidth={{lg: '400px'}} margin='1em 0' fontSize={{md: '1.3em'}} lineHeight={{xs: '1.5em', lg: '1.7em'}} >Experience our seasonal menu in beautiful country surroundings. Eat the freshest produce from 
